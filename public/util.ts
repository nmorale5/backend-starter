...
const operations: operation[] = [
  ...
  {
    name: "Get votes for post",
    endpoint: "/api/votes/:content",
    method: "GET",
    fields: { content: "input" },
  },
  {
    name: "Send Upvote",
    endpoint: "/api/votes/:content/upvote",
    method: "PUT",
    fields: { content: "input" },
  },
  {
    name: "Send Downvote",
    endpoint: "/api/votes/:content/downvote",
    method: "PUT",
    fields: { content: "input" },
  },
  {
  ...
  {
    name: "Get all existing threads",
    endpoint: "/api/threads",
    method: "GET",
    fields: {},
  },
  {
    name: "Get posts from thread",
